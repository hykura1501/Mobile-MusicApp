...
class PlaylistOptionAdapter(private val options : List<PlaylistOption>) : RecyclerView.Adapter<PlaylistOptionAdapter.ViewHolder>() {

    var onItemClick: ((PlaylistOption) -> Unit)? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) : PlaylistOptionAdapter.ViewHolder {
